      ...
      <div className="wrap">
        <Reveal>
          ...
          <div className="contact-trust-row">
            <span className="contact-trust-item">
          ...
          <div className="contact-box">
            <div className="contact-in">
              ...
              <div className="contact-col">
                <h3 className="contact-col-title">Bize Ulaşın</h3>
                ...
                <div className="contact-social-block">
                  <p className="contact-social-title">Bizi Takip Edin</p>
              ...
              <div className="contact-col contact-form-col">
                <h3 className="contact-col-title">Mesaj Gönderin</h3>

      ...
      >
        <div className="container flex h-16 items-center justify-between border-x border-muted">
          <div className="flex items-center gap-3">
            <Link href="/" className="flex items-center space-x-3">
              <motion.div
                ...
                className="h-10 w-10 rounded-3xl bg-accent flex items-center justify-center"
              >
          ...
          <nav className="hidden md:flex gap-3">
            <Link href="#services" className="text-sm font-medium transition-colors hover:text-accent">
              Services
            </Link>
            <Link href="#work" className="text-sm font-medium transition-colors hover:text-accent">
              Work
            </Link>
            <Link href="#about" className="text-sm font-medium transition-colors hover:text-accent">
              About
            </Link>
            <Link href="#clients" className="text-sm font-medium transition-colors hover:text-accent">
              Clients
            </Link>
          ...
          <div className="hidden md:flex items-center gap-3">
            ...
            <Button size="sm" className="rounded-3xl bg-accent hover:bg-accent-dark">
              Get Started
            </Button>
          </div>
      ...
      {isMenuOpen && (
        ...
        >
          <div className="container flex h-16 items-center justify-between">
            <div className="flex items-center gap-3">
              <Link href="/" className="flex items-center space-x-3">
                <div className="h-10 w-10 rounded-3xl bg-accent flex items-center justify-center">
                  <Sparkles className="h-5 w-5 text-white" />
                </div>
                <span className="font-bold text-xl">Studio</span>
              </Link>
          ...
          >
            {["Services", "Work", "About", "Clients", "Contact"].map((item, index) => (
              <motion.div key={index} variants={itemFadeIn}>
                <Link
                  ...
                  className="flex items-center justify-between rounded-3xl px-3 py-2 text-lg font-medium hover:bg-accent/10"
                  onClick={toggleMenu}
                >
                  {item}
            ...
            <motion.div variants={itemFadeIn} className="flex flex-col gap-3 pt-4">
              ...
              <Button className="w-full rounded-3xl bg-accent hover:bg-accent-dark">Get Started</Button>
            </motion.div>
          </motion.nav>
        </motion.div>
      )}
          ...
          <div className="container px-4 md:px-6 border border-muted rounded-3xl bg-gradient-to-br from-background to-muted/30">
            <div className="grid gap-3 lg:grid-cols-[1fr_400px] lg:gap-3 xl:grid-cols-[1fr_600px]">
              ...
              >
                ...
                >
                  <Button size="lg" className="rounded-3xl bg-accent hover:bg-accent-dark group">
                    Get Started
                    <motion.span
                      initial={{ x: 0 }}
                      whileHover={{ x: 5 }}
              ...
              {[
                ...
                >
                  <div className="rounded-3xl border p-6 bg-background/80 hover:shadow-md transition-all">
                    ...
                    <p className="text-xs text-center mt-2 font-medium">{client.name}</p>
                  </div>
                </motion.div>
              ))}
            </motion.div>
          ...
          >
            ...
            >
              ...
              >
                <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent opacity-0 transition-opacity group-hover:opacity-100"></div>
                <Image
                  src="https://images.unsplash.com/photo-1558655146-9f40138edfeb?w=600&auto=format&fit=crop"
              ...
              >
                <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent opacity-0 transition-opacity group-hover:opacity-100"></div>
                <Image
                  src="https://images.unsplash.com/photo-1462331940025-496dfbfc7564?w=1200&auto=format&fit=crop"
        ...
        <section id="about" className="w-full py-12 md:py-24 lg:py-32">
          ...
          >
            ...
            <div className="mt-16 px-6 pb-10">
              ...
              >
                {[
                  { name: "Alex Johnson", role: "Creative Director", image: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=300&auto=format&fit=crop" },
                  { name: "Sam Taylor", role: "Lead Designer", image: "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=300&auto=format&fit=crop" },
                  { name: "Jordan Smith", role: "Senior Developer", image: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=300&auto=format&fit=crop" },
                  { name: "Casey Brown", role: "Project Manager", image: "https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=300&auto=format&fit=crop" },
                ].map((member, index) => (
                  <motion.div
                    key={index}
                    variants={itemFadeIn}
              ...
              <div className="mt-8 flex space-x-3">
                {[
                  ...
                  <motion.div key={index} whileHover={{ y: -5, scale: 1.1 }} whileTap={{ scale: 0.9 }}>
                    <Link
                      href="#"
                      className="rounded-3xl border p-2 text-muted-foreground hover:text-foreground hover:border-accent transition-colors"
                    >
                      {social.icon}
            ...
            >
              ...
              <form className="mt-6 space-y-3">
                ...
                <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
                  <Button type="submit" className="w-full rounded-3xl bg-accent hover:bg-accent-dark">
                    Send Message
                  </Button>
                </motion.div>
              </form>
        ...
        >
          ...
          <div className="space-y-3">
            ...
            <form className="flex space-x-3">
              ...
              <Button type="submit" className="rounded-3xl bg-accent hover:bg-accent-dark">
                Subscribe
              </Button>
            </form>
          </div>
